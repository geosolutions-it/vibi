								...
								<div>
									...
									<div class="tabs">
										<ul>
											...
											<li>
												<a href="flowinfo.do?fmId=${fm.id}" title="tab-instances-<%= i %>" style="cursor: default">Instances</a> 
                                                <a class="autorefresh" id="<%= i %>" title="flowinfo.do?fmId=${fm.id}">
                                                    <img id="loading" src="img/arrow_refresh.png" style="display:none;cursor: wait"/>
                                                    <img id="loaded" src="img/arrow_refresh.png" style="cursor: pointer; cursor: hand"/>
                                                </a>
											</li>
										</ul>
										<div id="tab-config-<%= i %>">
