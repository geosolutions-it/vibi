...
CREATE MATERIALIZED VIEW metric_calculations AS
  SELECT * FROM vibi_values
  UNION
  SELECT * FROM vibi_e_index
  UNION
  SELECT * FROM vibi_ecst_index
  UNION
  SELECT * FROM vibi_sh_index
  UNION
  SELECT * FROM vibi_f_index;
