...
CREATE OR REPLACE VIEW herb_rel_cover_joined AS (
SELECT a.plot_no AS plot_id, a.species, a. relative_cover, b.acronym FROM herbaceous_relative_cover a
LEFT JOIN species b ON a.species = b.scientific_name);

CREATE OR REPLACE VIEW herb_plot_x_species_matrix AS (SELECT * FROM crosstab(                 
       'SELECT plot_id, acronym, relative_cover
        FROM   herb_rel_cover_joined
        ORDER  BY 1'
        ,$$VALUES ('ACARHO'),
('ACENEG'),
('ACENIG'),
...
('TRIAUR')
$$) 
        AS ("plot_id" text, "ACARHO" numeric,
"ACENEG" numeric,
"ACENIG" numeric,
"ACEPLA" numeric,
"ACERUB" numeric,
